  ...
  <Layout>
    <main>
      <header class="max-w-xl md:max-w-2xl xl:max-w-3xl mx-auto text-center px-6 pt-24">
        ...
        <p class="text-grey-dark text-lg sm:text-3xl">Where the &#127814; and &#x1F351; roam free.</p>
      </header>
      ...
      >
        <div class="markdown text-lg leading-normal text-gray-700">
          <p>Making art and sharing what I see on my own terms.</p>
        </div>
      </article>
      ...
      meta: [
        {
          key: "description",
          name: "description",
          content: "About the website Eggplant and Peaches"
        },
